...
public class PredicatesTest extends TestCase {
    ...
    public void testCommon() {
        final List<Predicate<Integer>> predicates = Lists.newArrayList(
                new Predicate<Integer>() {
                    @Override
        ...
        assertTrue(Predicates.and(predicates).apply(30));
        assertFalse(Predicates.and(predicates).apply(9));
        assertTrue(Predicates.or(predicates).apply(9));
